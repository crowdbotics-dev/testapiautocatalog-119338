...
## Project Structure
    ...
    ├── testapiautocatalog_119338  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_119338`
...
2. Clone this repo and `cd testapiautocatalog_119338`
